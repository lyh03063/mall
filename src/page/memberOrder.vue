          ...
          <div class="order-tab">
            <el-tabs :tab-position="tabPosition">
              ...
              <el-tab-pane label="已发货">
                <div class="order-list-item" v-for="shop in shopStatus3" :key="shop.P1">
                  <!-- 订单头部店铺名称，交易情况 -->
                  <div class="order-list-item__header" type="list-item-header">
                    店铺：米柚生活
                    <!-- <span class="order-list-item__header__state">交易关闭</span> -->
              ...
              <el-tab-pane label="已完成">
                <div class="order-list-item" v-for="shop in shopStatus4" :key="shop.P1">
                  <!-- 订单头部店铺名称，交易情况 -->
                  <div class="order-list-item__header" type="list-item-header">
                    店铺：米柚生活
                    <!-- <span class="order-list-item__header__state">交易关闭</span> -->
              ...
              <el-tab-pane label="已取消">
                <div class="order-list-item" v-for="shop in shopStatus5" :key="shop.P1">
                  <!-- 订单头部店铺名称，交易情况 -->
                  <div class="order-list-item__header" type="list-item-header">
                    店铺：米柚生活
                    <!-- <span class="order-list-item__header__state">交易关闭</span> -->
      ...
      .then(response => {
        ...
        for (let i = 0; i < this.shops.length; i++) {
          ...
          if (this.shops[shopIndex].status == 1) {
            ...
            this.shopStatus5.push(this.shops[shopIndex]);
            console.log("订单取消");
          }
