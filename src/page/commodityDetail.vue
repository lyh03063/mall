<template>
  <div class="main" style="margin:0px;padding:0px; background-color:rgb(242,242,242)">
      ...
      >
        <div class>
          ...
          <div>
            <router-link to="/home">
              <div
                style="border-width: 0 0 2px 0;border-style: solid;border-color: rgb(248, 248, 248);"
              >
          ...
          <div style="padding:10px;">
            <div style=" margin-bottom:20px;font-size:17px;color:gray;line-height: 25px;">
    ...
    <div class="buyProduct">
      <div
        style="float:left;width:13%;height:60px;border-width: 0 2px 0px 0;border-style: solid;border-color: rgb(248, 248, 248);"
      >
        <div
          class="el-icon-chat-dot-round"
          style="height:30px;line-height:30px;color:red;font-size:23px;cursor:pointer;padding-left:43%;"
        ></div>
        ...
        <router-link to="/cart">
          <div class="WP100 HP100" style>
            <div
              ...
              style="height:30px;line-height:30px;color:gray;font-size:23px;cursor:pointer;padding-left:40%;"
            ></div>
      ...
      <div
        ...
        style="float:left;width:37%;height:60px;background-color: rgb(255, 136, 85);color:white;text-align:center;line-height:60px;font-size:20px;"
      >加入购物车</div>
      <div
        @click="purchase(product)"
        style="float:left;width:37%;height:60px;background-color: rgb(255, 68, 68);color:white;text-align:center;line-height:60px;font-size:20px;"
      >立即购买</div>
    </div>
